...
public class CharakterTest {
    ...
    void checkConstructor(){
        spielfigur = Mockito.mock(Charakter.class, Mockito.withSettings().useConstructor(NAME, INTELLIGENZ, STAERKE, KONSTITUTION, WEISHEIT, GESCHICKLICHKEIT, BASIS_LP).defaultAnswer(Answers.CALLS_REAL_METHODS));
